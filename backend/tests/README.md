...
```bash
python run_all.py          # all five tests; logs + JSON into results/
python run_all.py 01 02    # only the selected tests
...
| `test_05_ocr_expiry.py` | Expiry date OCR and parsing |
